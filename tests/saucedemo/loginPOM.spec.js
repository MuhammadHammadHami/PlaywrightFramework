...
test('Login with invalid credentials', async ({page})=>{
    ...
    await expect(page).toHaveTitle(newData.invalidData.pageTitle)
    await loginPage.invalidLogin(newData.invalidData.usernameValue,newData.invalidData.userPasswordValue)
